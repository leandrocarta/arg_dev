              ...
              @endif 
                <form class="form-horizontal" method="POST" action="{{ route('destinos.create') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                              <textarea class="form-control" name="detalle_gral" rows="5">{{ old('detalle_gral') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ubicacion" class="col-md-4 control-label">Ubicación</label>
                            <div class="">
                              <textarea class="form-control" name="ubicacion" rows="5">{{ old('ubicacion') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="playas" class="col-md-4 control-label">Playas</label>
                            <div class="">
                              <textarea class="form-control" name="playas" rows="5">{{ old('playas') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="gastronomia" class="col-md-4 control-label">Gastronomía</label>
                            <div class="">
                              <textarea class="form-control" name="gastronomia" rows="5">{{ old('gastronomia') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="atracciones" class="col-md-4 control-label">Atracciones</label>
                            <div class="">
                              <textarea class="form-control" name="atracciones" rows="5">{{ old('atracciones') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="historia" class="col-md-4 control-label">Historia</label>
                            <div class="">
                              <textarea class="form-control" name="historia" rows="5">{{ old('historia') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="resumen" class="col-md-4 control-label">Resumen</label>
                            <div class="">
                              <textarea class="form-control" name="resumen" rows="5">{{ old('resumen') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
